...
namespace RHI::Vulkan {
    ...
    VK_ECIMPL_BEGIN(CompareFunc, VkCompareOp)
        VK_ECIMPL_ITEM(CompareFunc::never, VK_COMPARE_OP_NEVER)
        VK_ECIMPL_ITEM(CompareFunc::less, VK_COMPARE_OP_LESS)
        VK_ECIMPL_ITEM(CompareFunc::equal, VK_COMPARE_OP_EQUAL)
        VK_ECIMPL_ITEM(CompareFunc::lessEqual, VK_COMPARE_OP_LESS_OR_EQUAL)
        VK_ECIMPL_ITEM(CompareFunc::greater, VK_COMPARE_OP_GREATER)
        VK_ECIMPL_ITEM(CompareFunc::notEqual, VK_COMPARE_OP_NOT_EQUAL)
        VK_ECIMPL_ITEM(CompareFunc::greaterEqual, VK_COMPARE_OP_GREATER_OR_EQUAL)
        VK_ECIMPL_ITEM(CompareFunc::always, VK_COMPARE_OP_ALWAYS)
