...
namespace RHI::DirectX12 {
    ...
    DX12_ENUM_MAP_BEGIN(TextureViewDimension, D3D12_DSV_DIMENSION)
        DX12_ENUM_MAP_ITEM(TextureViewDimension::tv1D, D3D12_DSV_DIMENSION_TEXTURE1D)
        DX12_ENUM_MAP_ITEM(TextureViewDimension::tv2D, D3D12_DSV_DIMENSION_TEXTURE2D)
        DX12_ENUM_MAP_ITEM(TextureViewDimension::tv2DArray, D3D12_DSV_DIMENSION_TEXTURE2DARRAY)
    DX12_ENUM_MAP_END()
    ...
    DX12_ENUM_MAP_BEGIN(BufferState, D3D12_RESOURCE_STATES)
        ...
        DX12_ENUM_MAP_ITEM(BufferState::shaderReadOnly, D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE)
        DX12_ENUM_MAP_ITEM(BufferState::storage, D3D12_RESOURCE_STATE_UNORDERED_ACCESS)
        DX12_ENUM_MAP_ITEM(BufferState::vertex, D3D12_RESOURCE_STATE_GENERIC_READ)
        DX12_ENUM_MAP_ITEM(BufferState::index, D3D12_RESOURCE_STATE_GENERIC_READ)
        DX12_ENUM_MAP_ITEM(BufferState::indirectArguments, D3D12_RESOURCE_STATE_GENERIC_READ)
    DX12_ENUM_MAP_END()
    ...
    DX12_ENUM_MAP_BEGIN(TextureState, D3D12_RESOURCE_STATES)
        ...
        DX12_ENUM_MAP_ITEM(TextureState::shaderReadOnly, D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE)
