...
namespace RHI::DirectX12 {
    ...
    DX12_ENUM_MAP_BEGIN(HlslBindingRangeType, D3D12_DESCRIPTOR_RANGE_TYPE)
        DX12_ENUM_MAP_ITEM(HlslBindingRangeType::CONSTANT_BUFFER, D3D12_DESCRIPTOR_RANGE_TYPE_CBV)
        ...
        DX12_ENUM_MAP_ITEM(HlslBindingRangeType::UNORDERED_ACCESS, D3D12_DESCRIPTOR_RANGE_TYPE_UAV)
    DX12_ENUM_MAP_END()

    DX12_ENUM_MAP_BEGIN(ShaderStageBits, D3D12_SHADER_VISIBILITY)
        DX12_ENUM_MAP_ITEM(ShaderStageBits::S_VERTEX, D3D12_SHADER_VISIBILITY_VERTEX)
        DX12_ENUM_MAP_ITEM(ShaderStageBits::S_PIXEL, D3D12_SHADER_VISIBILITY_PIXEL)
        DX12_ENUM_MAP_ITEM(ShaderStageBits::S_COMPUTE, D3D12_SHADER_VISIBILITY_ALL)
    DX12_ENUM_MAP_END()
