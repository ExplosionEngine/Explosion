...
namespace RHI::DirectX12 {
    ...
    DX12_ECIMPL_BEGIN(CompareFunc, D3D12_COMPARISON_FUNC)
        DX12_ECIMPL_ITEM(CompareFunc::never, D3D12_COMPARISON_FUNC_NEVER)
        DX12_ECIMPL_ITEM(CompareFunc::less, D3D12_COMPARISON_FUNC_LESS)
        DX12_ECIMPL_ITEM(CompareFunc::equal, D3D12_COMPARISON_FUNC_EQUAL)
        DX12_ECIMPL_ITEM(CompareFunc::lessEqual, D3D12_COMPARISON_FUNC_LESS_EQUAL)
        DX12_ECIMPL_ITEM(CompareFunc::greater, D3D12_COMPARISON_FUNC_GREATER)
        DX12_ECIMPL_ITEM(CompareFunc::notEqual, D3D12_COMPARISON_FUNC_NOT_EQUAL)
        DX12_ECIMPL_ITEM(CompareFunc::greaterEqual, D3D12_COMPARISON_FUNC_GREATER_EQUAL)
        DX12_ECIMPL_ITEM(CompareFunc::always, D3D12_COMPARISON_FUNC_ALWAYS)
    ...
    DX12_ECIMPL_BEGIN(FillMode, D3D12_FILL_MODE)
        DX12_ECIMPL_ITEM(FillMode::wireframe, D3D12_FILL_MODE_WIREFRAME)
        DX12_ECIMPL_ITEM(FillMode::solid, D3D12_FILL_MODE_SOLID)
    DX12_ECIMPL_END(D3D12_FILL_MODE)
    ...
    DX12_ECIMPL_BEGIN(BlendFactor, D3D12_BLEND)
        ...
        DX12_ECIMPL_ITEM(BlendFactor::dst, D3D12_BLEND_DEST_COLOR)
    ...
    DX12_ECIMPL_BEGIN(BufferState, D3D12_RESOURCE_STATES)
        ...
        DX12_ECIMPL_ITEM(BufferState::staging, D3D12_RESOURCE_STATE_GENERIC_READ)
