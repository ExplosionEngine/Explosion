...
namespace Common::Internal {
    ...
    IMPL_INDEX_TO_STD_PLACEHOLDER(11)
    IMPL_INDEX_TO_STD_PLACEHOLDER(12)
    IMPL_INDEX_TO_STD_PLACEHOLDER(13)
    IMPL_INDEX_TO_STD_PLACEHOLDER(14)
    IMPL_INDEX_TO_STD_PLACEHOLDER(15)
    IMPL_INDEX_TO_STD_PLACEHOLDER(16)
    IMPL_INDEX_TO_STD_PLACEHOLDER(17)
    IMPL_INDEX_TO_STD_PLACEHOLDER(18)
    IMPL_INDEX_TO_STD_PLACEHOLDER(19)
    IMPL_INDEX_TO_STD_PLACEHOLDER(20)
}
