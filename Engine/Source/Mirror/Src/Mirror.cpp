...
namespace Mirror {
    ...
    const TypeInfo* StdOptionalView::BaseType() const
    {
        return rtti->getBaseType();
    }
    ...
    Any StdOptionalView::GetValue() const
    {
    ...
    const TypeInfo* StdPairView::GetKeyType() const
    {
        return rtti->getKeyType();
    }

    const TypeInfo* StdPairView::GetValueType() const
    {
        return rtti->getValueType();
    }

    Any StdPairView::GetKey() const
    {
        return rtti->getKey(obj);
    }

    Any StdPairView::GetValue() const
    {
        return rtti->getValue(obj);
    }

    Any StdPairView::GetConstKey() const
    {
        return rtti->getConstKey(obj);
    }

    Any StdPairView::GetConstValue() const
    {
    ...
    const TypeInfo* StdArrayView::GetElementType() const
    {
        return rtti->getElementType();
    }

    size_t StdArrayView::GetSize() const
    {
        return rtti->getSize();
    }

    Any StdArrayView::GetElement(size_t inIndex) const
    {
        return rtti->getElement(obj, inIndex);
    }

    Any StdArrayView::GetConstElement(size_t inIndex) const
    {
    ...
    size_t StdVectorView::GetSize() const
    {
        return rtti->getSize(obj);
    }

    Any StdVectorView::GetElement(size_t inIndex) const
    {
        return rtti->getElement(obj, inIndex);
    }

    Any StdVectorView::GetConstElement(size_t inIndex) const
    {
        return rtti->getConstElement(obj, inIndex);
    }
    ...
    const TypeInfo* StdListView::GetElementType() const
    {
        return rtti->getElementType();
    }

    size_t StdListView::GetSize() const
    {
        return rtti->getSize(obj);
    }
    ...
    Any StdListView::GetBeginIter() const
    {
        return rtti->getBeginIter(obj);
    }

    Any StdListView::GetEndIter() const
    {
        return rtti->getEndIter(obj);
    }

    Any StdListView::GetBeginConstIter() const
    {
        return rtti->getBeginConstIter(obj);
    }

    Any StdListView::GetEndConstIter() const
    {
        return rtti->getEndConstIter(obj);
    }

    Any StdListView::GetNextIter(const Argument& inIter) const
    {
        return rtti->getNextIter(inIter);
    }

    Any StdListView::GetLastIter(const Argument& inIter) const
    {
        return rtti->getLastIter(inIter);
    }

    Any StdListView::GetNextConstIter(const Argument& inIter) const
    {
        return rtti->getNextConstIter(inIter);
    }

    Any StdListView::GetLastConstIter(const Argument& inIter) const
    {
        return rtti->getLastConstIter(inIter);
    }

    Any StdListView::DerefIter(const Argument& inIter) const
    {
        return rtti->derefIter(inIter);
    }

    Any StdListView::DerefConstIter(const Argument& inIter) const
    {
        return rtti->derefConstIter(inIter);
    }
    ...
    const TypeInfo* StdUnorderedSetView::GetElementType() const
    {
        return rtti->getElementType();
    }

    size_t StdUnorderedSetView::GetSize() const
    {
        return rtti->getSize(obj);
    }
    ...
    const TypeInfo* StdSetView::GetElementType() const
    {
        return rtti->getElementType();
    }

    size_t StdSetView::GetSize() const
    {
        return rtti->getSize(obj);
    }
    ...
    const TypeInfo* StdUnorderedMapView::GetKeyType() const
    {
        return rtti->getKeyType();
    }

    const TypeInfo* StdUnorderedMapView::GetValueType() const
    {
        return rtti->getValueType();
    }

    size_t StdUnorderedMapView::GetSize() const
    {
        return rtti->getSize(obj);
    }
    ...
    const TypeInfo* StdMapView::GetKeyType() const
    {
        return rtti->getKeyType();
    }

    const TypeInfo* StdMapView::GetValueType() const
    {
        return rtti->getValueType();
    }

    size_t StdMapView::GetSize() const
    {
        return rtti->getSize(obj);
    }
    ...
    size_t StdTupleView::GetSize() const
    {
        return rtti->getSize();
    }

    const TypeInfo* StdTupleView::GetElementType(size_t inIndex) const
    {
        return rtti->getElementType(inIndex);
    }

    Any StdTupleView::GetElement(size_t inIndex) const
    {
        return rtti->getElement(obj, inIndex);
    }

    void StdTupleView::Visit(const Visitor& inVisitor) const
    {
        rtti->visit(obj, inVisitor);
    }
} // namespace Mirror
