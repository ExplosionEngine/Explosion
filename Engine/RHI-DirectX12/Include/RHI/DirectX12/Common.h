...
namespace RHI::DirectX12 {
    ...
    DX12_ENUM_MAP_BEGIN(BufferBindingType, D3D12_DESCRIPTOR_RANGE_TYPE)
        DX12_ENUM_MAP_ITEM(BufferBindingType::UNIFORM, D3D12_DESCRIPTOR_RANGE_TYPE_SRV)
        DX12_ENUM_MAP_ITEM(BufferBindingType::STORAGE, D3D12_DESCRIPTOR_RANGE_TYPE_UAV)
        // TODO check this ?
        DX12_ENUM_MAP_ITEM(BufferBindingType::READ_ONLY_STORAGE, D3D12_DESCRIPTOR_RANGE_TYPE_SRV)
    DX12_ENUM_MAP_END()
