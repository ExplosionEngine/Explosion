...
namespace Explosion::RHI {
    ...
    void VulkanDevice::PrepareInstanceExtensions()
    {
    ...
    void VulkanDevice::PrepareDeviceExtensions()
    {
    ...
    const VkQueue& VulkanDevice::GetVkQueue()
    {
        return vkQueue;
    }

    uint32_t VulkanDevice::GetVkQueueFamilyIndex()
    {
        return vkQueueFamilyIndex.value();
    }

    const VkCommandPool& VulkanDevice::GetVkCommandPool()
    {
        return vkCommandPool;
    }

    const VkPhysicalDeviceMemoryProperties& VulkanDevice::GetVkPhysicalDeviceMemoryProperties()
    {
        return vkPhysicalDeviceMemoryProperties;
    }

    void VulkanDevice::PrepareLayers()
    {
#ifdef ENABLE_VALIDATION_LAYER
    ...
    void VulkanDevice::GetSelectedPhysicalDeviceProperties()
    {
